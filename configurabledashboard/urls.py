...
urlpatterns = [
                       ...
                       url(r'^add/(?P<id>[0-9]+)/$', CustomDashboardCreate.as_view(), name='custom_dashboard_add'),
                       url(r'^update/(?P<pk>[0-9]+)/$', CustomDashboardUpdate.as_view(template_name="configurable/admin/customdashboard_form.html"), name='custom_dashboard_update'),
                       url(r'^edit/(?P<pk>[0-9]+)/$', CustomDashboardUpdate.as_view(template_name="configurable/admin/customdashboard_modal_form.html"), name='custom_dashboard_edit'),
                       url(r'^map/(?P<pk>[0-9]+)/(?P<location>[0-9]+)/(?P<type>[-\w]+)/$', 'configurabledashboard.views.custom_dashboard_update_components', name='custom_dashboard_update_components'),
                       url(r'^remap/(?P<pk>[0-9]+)/(?P<location>[0-9]+)/(?P<type>[-\w]+)/$', CustomDashboardUpdate.as_view(template_name="configurable/admin/dashboard_component_remap.html"), name='custom_dashboard_unmap'),
                       ...
                       url(r'^component_update/(?P<pk>[0-9]+)/$', DashboardComponentUpdate.as_view(template_name="customdashboard/admin/dashboard_component_update_form.html"), name='custom_dashboard/component_update'),
                       ...
                       url(r'^data_assign/(?P<pk>[0-9]+)/$', DashboardComponentUpdate.as_view(template_name="customdashboard/admin/component_data_source_assign.html"), name='custom_dashboard/data_assign'),
