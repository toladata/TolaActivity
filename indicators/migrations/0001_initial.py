    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_uuid', models.CharField(default=uuid.uuid4, max_length=255, unique=True, verbose_name=b'Data UUID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_uuid', models.CharField(db_index=True, default=uuid.uuid4, max_length=255, verbose_name=b'Data UUID')),
                ('achieved', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=20, verbose_name=b'Achieved')),
                ('description', models.TextField(blank=True, null=True, verbose_name=b'Remarks/comments')),
                ('date_collected', models.DateTimeField(blank=True, null=True)),
                ('comment', models.TextField(blank=True, max_length=255, null=True, verbose_name=b'Comment/Explanation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('indicator_uuid', models.CharField(db_index=True, default=uuid.uuid4, max_length=255, verbose_name=b'Indicator UUID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('indicator_uuid', models.CharField(default=uuid.uuid4, max_length=255, unique=True, verbose_name=b'Indicator UUID')),
                ('name', models.CharField(max_length=255)),
                ('number', models.CharField(blank=True, max_length=255, null=True)),
                ('source', models.CharField(blank=True, max_length=255, null=True)),
                ('definition', models.TextField(blank=True, null=True)),
