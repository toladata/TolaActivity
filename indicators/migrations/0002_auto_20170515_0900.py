...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='agreement',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='q_agreement2', to='workflow.ProjectAgreement', verbose_name=b'Project Initiation'),
        ),
        migrations.AddField(
            model_name='collecteddata',
            name='approved_by',
        ...
        migrations.AddField(
            model_name='collecteddata',
            name='complete',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='q_complete2', to='workflow.ProjectComplete'),
        ),
        migrations.AddField(
            model_name='collecteddata',
        ...
        migrations.AddField(
            model_name='collecteddata',
            name='program',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='i_level1', to='workflow.WorkflowLevel1'),
        ),
        migrations.AddField(
            model_name='collecteddata',
            name='site',
