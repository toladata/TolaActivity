...
urlpatterns = [
    ...
    url(r'^program_report/(?P<program>\w+)/$', indicatorviews.WorkflowLevel1IndicatorReport,name='programIndicatorReport'),
    ...
    url(r'^collected_data_table/(?P<indicator>[-\w]+)/(?P<program>[-\w]+)/', indicatorviews.collected_data_json, name='collected_data_json'),
