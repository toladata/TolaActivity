...
urlpatterns = [
    ...
    # Indicator Report
    url(r'^report/(?P<workflowlevel1>\w+)/(?P<indicator>\w+)/(?P<type>\w+)/$', 'indicators.views.indicator_report', name='indicator_report'),
    url(r'^report_table/(?P<workflowlevel1>\w+)/(?P<indicator>\w+)/(?P<type>\w+)/$', IndicatorReport.as_view(), name='indicator_table'),
    url(r'^program_report/(?P<workflowlevel1>\w+)/$', 'indicators.views.WorkflowLevel1IndicatorReport',name='programIndicatorReport'),

    # Indicator Data Report
    url(r'^data/(?P<id>\w+)/(?P<workflowlevel1>\w+)/(?P<type>\w+)/$', 'indicators.views.indicator_data_report', name='indicator_data_report'),
    url(r'^data/(?P<id>\w+)/(?P<workflowlevel1>\w+)/(?P<type>\w+)/map/$', 'indicators.views.indicator_data_report', name='indicator_data_report'),
    url(r'^data/(?P<id>\w+)/(?P<workflowlevel1>\w+)/(?P<type>\w+)/graph/$', 'indicators.views.indicator_data_report', name='indicator_data_report'),
    url(r'^data/(?P<id>\w+)/(?P<workflowlevel1>\w+)/(?P<type>\w+)/table/$', 'indicators.views.indicator_data_report', name='indicator_data_report'),
    url(r'^data/(?P<id>\w+)/(?P<workflowlevel1>\w+)/$', 'indicators.views.indicator_data_report', name='indicator_data_report'),
    ...
    url(r'^program_indicators/(?P<workflowlevel1>[-\w]+)/(?P<indicator>[-\w]+)/(?P<type>[-\w]+)', 'indicators.views.workflowlevel1_indicators_json', name='workflowlevel1_indicators_json'),
