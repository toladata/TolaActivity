...
class IndicatorTestCase(TestCase):
    ...
    def test_generate_periodic_targets(self):
        ...
        data = {
            ...
            "periodic_targets": [
                {"id": 0, "period": "Year 1", "target": "7",
                 "start_date": "Apr 01, 2017", "end_date": "Mar 31, 2018"},
                {"id": 0, "period": "Year 2", "target": "7",
                 "start_date": "Apr 01, 2018", "end_date": "Mar 31, 2019"},
                {"id": 0, "period": "Year 3", "target": "7",
