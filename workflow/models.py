...
class WorkflowLevel3(models.Model):
    ...
    budget = models.DecimalField("Estimated Budget", decimal_places=2, max_digits=12, default=Decimal("0.00"), blank=True, null=True)
    cost = models.DecimalField("Actual Cost", decimal_places=2, max_digits=12, default=Decimal("0.00"), blank=True, null=True)
