    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lessons_learned', models.TextField(blank=True, null=True, verbose_name='Lessons learned')),
                ('status', models.CharField(choices=[('open', 'Open'), ('awaiting_approval', 'Awaiting Approval'), ('tracking', 'Tracking'), ('awaiting_verification', 'Awaiting Verification'), ('closed', 'Closed')], default='open', max_length=50)),
                ('approval_submitted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='submitted_by_agreement', to='workflow.TolaUser')),
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='approving_agreement', to='workflow.TolaUser', verbose_name='Request approval')),
        ...
        migrations.AddField(
            model_name='notes',
            name='note_from',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notes_from', to='workflow.TolaUser'),
        ),
        migrations.AddField(
            model_name='notes',
            name='note_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notes_to', to='workflow.TolaUser'),
        ),
        migrations.AddField(
            model_name='notes',
            name='organization',
