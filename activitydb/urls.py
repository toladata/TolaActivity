...
urlpatterns = [
                       ...
                       # url(r'^custom_dashboard/component_add/(?P<pk>[0-9]+)/$',  CustomDashboardCreate.as_view(), name='custom_dashboard/component_add'),
                       # url(r'^custom_dashboard/component_update/(?P<id>[0-9]+)/$',  CustomDashboardUpdate.as_view(), name='custom_dashboard/component_update'),
                       # url(r'^custom_dashboard/component_delete(?P<id>[0-9]+)/$',  CustomDashboardDelete.as_view(), name='custom_dashboard/component_delete'),
                      
                       url(r'^custom_dashboard/data/(?P<id>[0-9]+)/$', ComponentDataSourceList.as_view(), name='component_data_source_list'),
                       # url(r'^custom_dashboard/data_add/(?P<pk>[0-9]+)/$',  CustomDashboardCreate.as_view(), name='custom_dashboard/data_add'),
                       # url(r'^custom_dashboard/data_update/(?P<id>[0-9]+)/$',  CustomDashboardUpdate.as_view(), name='custom_dashboard/data_update'),
                       # url(r'^custom_dashboard/data_delete(?P<id>[0-9]+)/$',  CustomDashboardDelete.as_view(), name='custom_dashboard/data_delete'),
