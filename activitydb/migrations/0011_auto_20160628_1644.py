# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-06-28 23:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_filter_key', models.CharField(max_length=255, verbose_name='Color Scheme')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(blank=True, null=True)),
                ('edit_date', models.DateTimeField(blank=True, null=True)),
                ('data_sources', models.ManyToManyField(to='activitydb.ComponentDataSource')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='color_palette',
            field=models.CharField(default='bright', max_length=255, verbose_name='Color Scheme'),
        ),
        ...
        migrations.AddField(
            model_name='customdashboard',
            name='theme',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='theme', to='activitydb.DashboardTheme'),
        ),
    ]
