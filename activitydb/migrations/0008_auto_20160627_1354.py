# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-06-27 20:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theme_template', models.CharField(blank=True, max_length=255, verbose_name='Dashboard Theme Name')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='activitydb.DashboardComponent'),
        ),
        migrations.AddField(
            model_name='customdashboard',
            name='dashboard_theme',
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='activitydb.DashboardTheme'),
        ),
    ]
