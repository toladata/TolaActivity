    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(blank=True, null=True)),
                ('edit_date', models.DateTimeField(blank=True, null=True)),
                ('checklist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='activitydb.Checklist')),
            ],
            options={
                'ordering': ('item',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fund_code', models.ManyToManyField(blank=True, to='activitydb.FundCode')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(blank=True, null=True)),
                ('edit_date', models.DateTimeField(blank=True, null=True)),
                ('admin_level_three', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='activitydb.AdminLevelThree', verbose_name='Administrative Level 3')),
            ],
            options={
                'ordering': ('name',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(blank=True, null=True)),
                ('edit_date', models.DateTimeField(blank=True, null=True)),
                ('countries', models.ManyToManyField(blank=True, related_name='countries', to='activitydb.Country', verbose_name='Accessible Countries')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(blank=True, null=True)),
                ('edit_date', models.DateTimeField(blank=True, null=True)),
                ('admin_3', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='activitydb.AdminLevelThree', verbose_name='Admin Level 3')),
                ('district', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='activitydb.District')),
            ],
            options={
                'ordering': ('name',),
        ...
        migrations.AddField(
            model_name='stakeholder',
            name='contact',
            field=models.ManyToManyField(blank=True, max_length=255, to='activitydb.Contact'),
        ),
        migrations.AddField(
            model_name='stakeholder',
            name='country',
        ...
        migrations.AddField(
            model_name='projectcomplete',
            name='program',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='complete', to='activitydb.Program'),
        ),
        migrations.AddField(
            model_name='projectcomplete',
        ...
        migrations.AddField(
            model_name='projectagreement',
            name='capacity',
            field=models.ManyToManyField(blank=True, to='activitydb.Capacity', verbose_name='Sustainability Plan'),
        ),
        migrations.AddField(
            model_name='projectagreement',
            name='checked_by',
        ...
        migrations.AddField(
            model_name='projectagreement',
            name='evaluate',
            field=models.ManyToManyField(blank=True, to='activitydb.Evaluate'),
        ),
        migrations.AddField(
            model_name='projectagreement',
        ...
        migrations.AddField(
            model_name='program',
            name='sector',
            field=models.ManyToManyField(blank=True, to='activitydb.Sector'),
        ),
        migrations.AddField(
            model_name='program',
            name='user_access',
            field=models.ManyToManyField(blank=True, to='activitydb.TolaUser'),
        ),
        migrations.AddField(
            model_name='office',
            name='province',
        ...
        migrations.AddField(
            ...
            name='approved_by',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='activitydb.TolaUser'),
        ),
        migrations.AddField(
            model_name='historicalsiteprofile',
            name='classify_land',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='activitydb.LandType'),
        ),
        migrations.AddField(
            model_name='historicalsiteprofile',
            name='country',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='activitydb.Country'),
        ),
        migrations.AddField(
            model_name='historicalsiteprofile',
            name='district',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='activitydb.District'),
        ),
        migrations.AddField(
            model_name='historicalsiteprofile',
            name='filled_by',
        ...
        migrations.AddField(
            model_name='historicalsiteprofile',
            name='office',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='activitydb.Office'),
        ),
        migrations.AddField(
            model_name='historicalsiteprofile',
            name='province',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='activitydb.Province'),
        ),
        migrations.AddField(
            model_name='historicalsiteprofile',
            name='type',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='activitydb.ProfileType'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='historicalprojectcomplete',
            name='project_agreement',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='activitydb.ProjectAgreement'),
        ),
        migrations.AddField(
            model_name='historicalprojectcomplete',
            name='project_type',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='activitydb.ProjectType'),
        ),
        migrations.AddField(
            model_name='historicalprojectcomplete',
            name='reviewed_by',
        ...
        migrations.AddField(
            model_name='historicalbudget',
            name='complete',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='activitydb.ProjectComplete'),
        ),
        migrations.AddField(
            model_name='historicalbudget',
            name='history_user',
        ...
        migrations.AddField(
            model_name='feedback',
            name='submitter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='activitydb.TolaUser'),
        ),
        migrations.AddField(
