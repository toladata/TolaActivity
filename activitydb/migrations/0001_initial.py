...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gaitid', models.CharField(blank=True, max_length=255, unique=True, verbose_name='GAITID')),
                ...
                ('create_date', models.DateTimeField(blank=True, null=True)),
                ('edit_date', models.DateTimeField(blank=True, null=True)),
                ('budget_check', models.BooleanField(default=False, verbose_name='Enable Approval Authority Matrix')),
                ('country', models.ManyToManyField(to='activitydb.Country')),
                ('dashboard_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='activitydb.CustomDashboard')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ('create_date',),
                'permissions': (('can_approve', 'Can approve agreement'),),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edit_date', models.DateTimeField(blank=True, null=True)),
                ('program', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='activitydb.Program')),
                ('project_agreement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='activitydb.ProjectAgreement')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(blank=True, null=True)),
                ('edit_date', models.DateTimeField(blank=True, null=True)),
                ('admin_3', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='activitydb.AdminLevelThree')),
        ...
        migrations.AddField(
            model_name='siteprofile',
            name='office',
            field=models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, to='activitydb.Office'),
        ),
        migrations.AddField(
            model_name='siteprofile',
            name='province',
        ...
        migrations.AddField(
            model_name='historicalprojectcomplete',
            name='dashboard_name',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='activitydb.CustomDashboard'),
        ),
        migrations.AddField(
            model_name='historicalprojectcomplete',
            name='estimated_by',
        ...
        migrations.AddField(
            model_name='historicalprojectagreement',
            name='project_type_other',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='activitydb.ProjectTypeOther'),
        ),
        migrations.AddField(
            model_name='historicalprojectagreement',
            name='reviewed_by',
        ...
        migrations.AddField(
            ...
            name='district',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='activitydb.District'),
        ),
    ]
