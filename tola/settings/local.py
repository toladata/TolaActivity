...
##INTERNATIONALIZATION_DATA_URL

INTERNATIONALIZATION_RESOURCE_URL = os.getenv('INTERNATIONALIZATION_RESOURCE_URL')
...
SET_PROGRAM_ADMIN_DEFAULT = True if os.getenv('SET_PROGRAM_ADMIN_DEFAULT') == 'True' else False
