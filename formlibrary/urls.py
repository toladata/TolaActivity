...
urlpatterns = [
                       ...
                       url(r'^training_objects/(?P<pk>\w+)/$', TrainingListObjects.as_view(), name='training_objects'),
                       ...
                       url(r'^beneficiary_objects/(?P<pk>\w+)/$', BeneficiaryListObjects.as_view(), name='beneficiary_objects'),
                       ...
                       url(r'^distribution_objects/(?P<pk>\w+)/$', DistributionListObjects.as_view(), name='distribution_list'),
