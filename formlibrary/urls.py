...
urlpatterns = [
                       ...
                       url(r'^training_objects/(?P<workflowlevel1>\w+)/(?P<workflowlevel2>\w+)/$', TrainingListObjects.as_view(), name='training_objects'),
                       ...
                       url(r'^beneficiary_objects/(?P<workflowlevel1>\w+)/(?P<workflowlevel2>\w+)/$', BeneficiaryListObjects.as_view(), name='beneficiary_objects'),
                       ...
                       url(r'^distribution_objects/(?P<workflowlevel1>\w+)/(?P<workflowlevel2>\w+)/$', DistributionListObjects.as_view(), name='distribution_list'),
                       ...
                       url(r'^distribution_delete/(?P<pk>\w+)/$', DistributionDelete.as_view(), name='distribution_delete'),
                        ...
                        url(r'^getagreements/(?P<workflowlevel1>\w+)/(?P<workflowlevel2>\w+)/$', GetAgreements.as_view(), name='getagreements'),
